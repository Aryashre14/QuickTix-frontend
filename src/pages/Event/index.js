      ...
      <div className="parent pt-16 my-16">
        <div className="">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
            ...
            >
              <img
                src="https://www.rateyourseats.com/assets/images/seating_charts/static/new-england-patriots-seating-chart-with-rows-at-gillette-stadium.jpg"
            ...
            >
              ...
              <p className="text-primary font-medium text-center translate-y-[-100%] sm:translate-y-[-0%] sm:mb-2 md:text-left">
               EchoVerse event will take place at the Gillette Stadium on Sept 22, 2023.
               EchoVerse invited a number of collaborators & special guests to participate & be part of this concert.
              </p>
              <br />
