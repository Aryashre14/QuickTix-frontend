    ...
    <>
      <div className="parent py-24 mt-4">
        ...
        >
          ...
          <h1 className="text-4xl font-semibold drop-shadow-md text-center text-accent backcol">
            Get In <span className="text-primary drop-shadow-md text-accent">Touch</span>
          </h1>
          <BottomLine />
        </motion.div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          ...
          >
            ...
            <div className="flex items-center my-6">
              ...
              <h3 className="font-medium text-primary font-serif font-semibold">QuickTix</h3>
            </div>
            <div className="flex items-center my-6">
              <FaPhoneAlt className="text-2xl mr-8 text-primary cursor-pointer duration-300"></FaPhoneAlt>
              <h3 className="font-medium text-primary font-serif font-semibold">9431963215</h3>
            </div>
            <div className="flex items-center my-6">
              <MdEmail className="text-3xl mr-8 text-primary cursor-pointer duration-300 "></MdEmail>
              <h3 className="font-medium text-primary font-serif font-semibold">contact@quicktix.com</h3>
            </div>
            <div className="flex items-center my-6">
              <FaLocationArrow className="text-2xl mr-8 text-primary cursor-pointer duration-300"></FaLocationArrow>

              <h3 className="font-medium text-primary font-serif font-semibold">
                Ranchi,Jharkhand,India
              </h3>
            </div>
            <div className="mt-8 flex items-center">
              <h3 className="text-xl text-primary">Socials</h3>
              <div className="bg-primary w-10 h-[2px] mx-4"></div>
              <a
                href="https://www.linkedin.com/in/arya-shreshth/"
                target="blank"
                className="text-3xl text-primary hover:text-accent hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
              >
                <FaLinkedin className="backcol"></FaLinkedin>
              </a>
              <a
                href="/"
                target="blank"
                className="text-3xl text-primary hover:text-accent hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
              >
                <FaTwitterSquare className="backcol"></FaTwitterSquare>
              </a>
              <a
                href="/"
                target="blank"
                className="text-3xl text-primary hover:text-accent hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
              >
                <FaInstagramSquare className="backcol"></FaInstagramSquare>
              </a>
            </div>
          </motion.div>
        </div>
